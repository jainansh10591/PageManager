...
fb.views.Accounts = Backbone.View.extend({

    initialize: function () {
        this.template = _.template(fb.templateLoader.get('accounts'));
        this.model.on("change", this.render, this);
        this.render();
    },
...
fb.views.Post = Backbone.View.extend({
    ...
    postMessage: function () {
        var status = {
                ...
                access_token: "CAACEdEose0cBAAPaXsYETF4pASZBNBViJSkkoS36PuX6Xu1K2P9Kj1X0SEepHrgLq2e7JBGLPg40j3Lj3ZCrTIApKSvRV5aS4KZAr6RxWQnUhYSeKprZAyrb1mTsdHZCmsFrbGG36gRnFbZCXcgKIgxfJnqTCnch3wpSZBIHugHVE0o5khcEix1TXdjFDGEPA9qZBhVeBZCBfx9rqiYkUJC0R"
            };
